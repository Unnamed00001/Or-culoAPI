...
var lettresControlles_exports = {};
__export(lettresControlles_exports, {
  deleteLetter: () => deleteLetter2,
  getLettres: () => getLettres,
  getLettresByCategory: () => getLettresByCategory,
  getLettresById: () => getLettresById,
  postCreateLetter: () => postCreateLetter,
  putUpdateLetter: () => putUpdateLetter
});
module.exports = __toCommonJS(lettresControlles_exports);
